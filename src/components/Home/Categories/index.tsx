...
const Categories = () => {
  ...
  return (
    <section className="overflow-hidden pt-17.5 bg-[var(--brutal-bg)]">
        ...
        <div className="swiper categories-carousel common-carousel">
          <div className="mb-10 flex items-center justify-between">
            <div>
                ...
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clipPath="url(#clip0_834_7356)">
                    <path
                      ...
                      strokeWidth="1.5"
                    />
                    <circle cx="7.17245" cy="7.39917" r="1.66667" transform="rotate(-45 7.17245 7.39917)" stroke="currentColor" strokeWidth="1.5" />
                    <path d="M9.61837 15.4164L15.4342 9.6004" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                  </g>
                  <defs>
              ...
              <h2 className="font-black text-xl xl:text-heading-5 text-[var(--brutal-black)]">
                BROWSE BY CATEGORY
              </h2>
            </div>
