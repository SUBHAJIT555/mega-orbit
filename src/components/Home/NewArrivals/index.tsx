...
const NewArrival = ({ products }: NewArrivalProps) => {
  return (
    <section className="overflow-hidden pt-15 bg-[var(--brutal-bg)]">
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
        ...
        <div className="mb-7 flex items-center justify-between">
          <div>
            ...
            <h2 className="font-black text-xl xl:text-heading-5 text-[var(--brutal-black)]">NEW ARRIVALS</h2>
          </div>
          <Link href="/shop" className="inline-flex font-black text-custom-sm py-2.5 px-7 rounded-none border-2 border-[var(--brutal-black)] bg-[var(--brutal-yellow)] text-[var(--brutal-black)] brutal-btn">
            VIEW ALL
          </Link>
        </div>
