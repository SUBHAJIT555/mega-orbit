  ...
  return (
    ...
    >
      <div className="flex items-center justify-end">
        <div className="w-full max-w-[500px] bg-white border-l-4 border-[var(--brutal-black)] px-4 sm:px-7.5 lg:px-11 relative modal-content rounded-none">
          <div className="sticky top-0 bg-white flex items-center justify-between pb-7 pt-4 sm:pt-7.5 lg:pt-11 border-b-4 border-[var(--brutal-black)] mb-7.5">
            <h2 className="font-black text-[var(--brutal-black)] text-lg sm:text-2xl">
              CART — MEGA ORBIT
            </h2>
            <button
          ...
          <div className="border-t border-gray-3 bg-white pt-5 pb-4 sm:pb-7.5 lg:pb-11 mt-7.5 sticky bottom-0">
            <div className="flex items-center justify-between gap-5 mb-6">
              ...
              <p className="font-medium text-xl text-dark">₹{totalPrice.toLocaleString('en-IN')}</p>
            </div>
            ...
            <div className="flex items-center gap-4">
              <Link
                onClick={() => closeCartModal()}
                href="/cart"
                className="w-full flex justify-center font-black text-[var(--brutal-black)] bg-[var(--brutal-yellow)] border-2 border-[var(--brutal-black)] py-[13px] px-6 rounded-none brutal-btn"
              >
                VIEW CART
              </Link>
              ...
              <Link
                href="/checkout"
                className="w-full flex justify-center font-black text-white bg-[var(--brutal-black)] border-2 border-[var(--brutal-black)] py-[13px] px-6 rounded-none brutal-btn"
              >
                CHECKOUT
              </Link>
            </div>
