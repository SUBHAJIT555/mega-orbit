...
const ProductItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden flex items-center justify-center rounded-none bg-white border-[3px] border-[var(--brutal-black)] min-h-[270px] mb-4 brutal-box group-hover:translate-x-0.5 group-hover:translate-y-0.5 group-hover:shadow-none transition-all">
        ...
        <div className="absolute left-0 bottom-0 translate-y-full w-full flex items-center justify-center gap-2.5 pb-5 ease-linear duration-200 group-hover:translate-y-0">
          ...
          <button
            ...
            className="inline-flex font-black text-custom-sm py-[7px] px-5 rounded-none bg-[var(--brutal-yellow)] text-[var(--brutal-black)] border-2 border-[var(--brutal-black)] brutal-btn"
          >
            Add to cart
          </button>
          ...
          <button
            ...
            id="favOne"
            className={`flex items-center justify-center w-9 h-9 rounded-none border-2 border-[var(--brutal-black)] bg-white brutal-btn ${isInWishlist ? "text-red bg-red-100" : "text-[var(--brutal-black)] hover:bg-[var(--brutal-yellow)]"}`}
          >
            <svg
              className="fill-current"
              width="16"
      ...
      <h3
        className="font-black text-[var(--brutal-black)] hover:underline mb-1.5 cursor-pointer"
