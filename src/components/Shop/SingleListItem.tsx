...
const SingleListItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group rounded-none bg-white border-[3px] border-[var(--brutal-black)] brutal-box">
      <div className="flex">
        <div className="relative overflow-hidden flex items-center justify-center max-w-[270px] w-full sm:min-h-[270px] p-4 border-r-2 border-[var(--brutal-black)]">
