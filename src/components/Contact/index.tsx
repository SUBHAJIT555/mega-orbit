      ...
      <section className="overflow-x-hidden py-20 bg-[var(--brutal-bg)] border-t-4 border-[var(--brutal-black)]">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex flex-col xl:flex-row gap-7.5">
            <div className="xl:max-w-[370px] w-full bg-white rounded-none border-[3px] border-[var(--brutal-black)] brutal-box-lg">
              <div className="py-5 px-4 sm:px-7.5 border-b-4 border-[var(--brutal-black)]">
                <p className="font-black text-xl text-[var(--brutal-black)] uppercase tracking-tight">
                  Contact Information
                </p>
              </div>
            ...
            <div className="xl:max-w-[770px] w-full bg-white rounded-none border-[3px] border-[var(--brutal-black)] brutal-box p-4 sm:p-7.5 xl:p-10">
              <form onSubmit={handleSubmit(onSubmit)}>
                <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
                  <div className="w-full">
                    ...
                    <input
                      ...
                      id="firstName"
                      placeholder="Jhon"
                      className={`rounded-none border-2 w-full py-2.5 px-5 outline-none duration-200 font-medium text-[var(--brutal-black)] placeholder:text-[var(--brutal-black)]/50 bg-white ${errors.firstName ? "border-red" : "border-[var(--brutal-black)]"
                        } focus:shadow-[2px_2px_0_0_var(--brutal-black)]`}
                    />
                    {errors.firstName && (
                      <p className="mt-1 text-sm font-bold text-red">{errors.firstName.message}</p>
                    )}
                  </div>
                  ...
                  <div className="w-full">
                    ...
                    <input
                      ...
                      id="lastName"
                      placeholder="Deo"
                      className={`rounded-none border-2 w-full py-2.5 px-5 outline-none duration-200 font-medium text-[var(--brutal-black)] placeholder:text-[var(--brutal-black)]/50 bg-white ${errors.lastName ? "border-red" : "border-[var(--brutal-black)]"
                        } focus:shadow-[2px_2px_0_0_var(--brutal-black)]`}
                    />
                    {errors.lastName && (
                      <p className="mt-1 text-sm font-bold text-red">{errors.lastName.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="mb-5">
                  ...
                  <input
                    ...
                    className={`rounded-none border-2 w-full py-2.5 px-5 outline-none duration-200 font-medium text-[var(--brutal-black)] placeholder:text-[var(--brutal-black)]/50 bg-white ${errors.email ? "border-red" : "border-[var(--brutal-black)]"
                      } focus:shadow-[2px_2px_0_0_var(--brutal-black)]`}
                  />
                  {errors.email && (
                ...
                <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
                  <div className="w-full">
                    <label htmlFor="subject" className="block mb-2.5 font-bold text-[var(--brutal-black)]">
                      Subject
                    </label>
                ...
                <div className="mb-7.5">
                  <label htmlFor="message" className="block mb-2.5 font-bold text-[var(--brutal-black)]">
                    Message
                  </label>
                ...
                {error && (
                  <p className="mb-4 text-sm font-bold text-red">{error}</p>
                )}
                {success && (
                  <p className="mb-4 text-sm font-bold text-green">Message sent successfully!</p>
                )}
