  ...
  return (
    <>
      <Breadcrumb
        ...
        pages={["shop",]}
      />
      <section className="overflow-x-hidden relative pb-20 pt-5 lg:pt-20 xl:pt-28 bg-[var(--brutal-bg)] border-t-4 border-[var(--brutal-black)]">
          ...
          <div className="flex gap-7.5">
            ...
            <div
              className={`sidebar-content fixed xl:z-1 z-9999 left-0 top-0 xl:translate-x-0 xl:static max-w-[310px] xl:max-w-[270px] w-full ease-out duration-200 ${productSidebar
                ? "translate-x-0 bg-white p-5 h-screen overflow-y-auto border-r-4 border-[var(--brutal-black)] brutal-box-lg"
                : "-translate-x-full"
                }`}
            >
              <button
                ...
                className={`xl:hidden absolute -right-12.5 sm:-right-8 flex items-center justify-center w-8 h-8 rounded-none bg-white border-2 border-[var(--brutal-black)] brutal-btn ${stickyMenu
              ...
              <form onSubmit={(e) => e.preventDefault()}>
                <div className="flex flex-col gap-6">
                  {/* <!-- filter box --> */}
                  <div className="bg-white rounded-none border-[3px] border-[var(--brutal-black)] brutal-box py-4 px-5">
                    <div className="flex items-center justify-between">
                      <p className="font-bold text-[var(--brutal-black)]">Filters:</p>
                      <button
                        onClick={handleClearFilters}
                        className="font-bold text-[var(--brutal-black)] border-b-2 border-[var(--brutal-black)] hover:bg-[var(--brutal-yellow)] px-1 -mb-0.5 brutal-btn"
                      >
                        Clear All
                      </button>
                    </div>
            ...
            {/* // <!-- Content Start --> */}
            <div className="xl:max-w-[870px] w-full shop-content">
              <div className="rounded-none bg-white border-[3px] border-[var(--brutal-black)] brutal-box pl-3 pr-2.5 py-2.5 mb-6">
                <div className="flex items-center justify-between">
                  {/* <!-- top bar left --> */}
                  <div className="flex flex-wrap items-center gap-4">
                    ...
                    <p className="font-bold text-[var(--brutal-black)]">
                      Showing <span>{startIndex + 1}-{Math.min(endIndex, filteredProducts.length)}</span> of{" "}
                  ...
                  <div className="flex items-center gap-2.5">
                    <button
                      ...
                      className={`${productStyle === "grid"
                        ? "bg-[var(--brutal-black)] text-white border-[var(--brutal-black)]"
                        : "bg-white text-[var(--brutal-black)] border-[var(--brutal-black)]"
                        } flex items-center justify-center w-10.5 h-9 rounded-none border-2 brutal-btn hover:bg-[var(--brutal-yellow)] hover:text-[var(--brutal-black)]`}
                    >
                      <svg
                        className="fill-current"
                        width="18"
              ...
              {totalPages > 1 && (
                <div className="flex justify-center mt-15">
                  <div className="bg-white rounded-none border-2 border-[var(--brutal-black)] brutal-box p-2">
                    <ul className="flex items-center gap-0.5">
                      <li>
                        <button
                          ...
                          className={`flex items-center justify-center w-8 h-9 ease-out duration-200 rounded-none border border-[var(--brutal-black)] ${currentPage === 1
                            ? "text-gray-4 cursor-not-allowed bg-[var(--brutal-bg)]"
                            : "bg-white text-[var(--brutal-black)] font-bold brutal-btn hover:bg-[var(--brutal-yellow)]"
                            }`}
                        >
                          <svg
                            className="fill-current"
                      ...
                      {getPageNumbers().map((page, index) => (
                        <li key={index}>
                          {page === '...' ? (
                            <span className="flex py-1.5 px-3.5 duration-200 rounded-none font-bold text-[var(--brutal-black)]">
                              ...
                            </span>
                          ) : (
                            <button
                              onClick={() => handlePageChange(page as number)}
                              className={`flex py-1.5 px-3.5 duration-200 rounded-none border border-[var(--brutal-black)] font-bold ${currentPage === page
                                ? "bg-[var(--brutal-black)] text-white"
                                : "bg-white text-[var(--brutal-black)] hover:bg-[var(--brutal-yellow)] brutal-btn"
                                }`}
                            >
                              {page}
                            </button>
                      ...
                      <li>
                        <button
                          ...
                          className={`flex items-center justify-center w-8 h-9 ease-out duration-200 rounded-none border border-[var(--brutal-black)] ${currentPage === totalPages
                            ? "text-gray-4 cursor-not-allowed bg-[var(--brutal-bg)]"
                            : "bg-white text-[var(--brutal-black)] font-bold brutal-btn hover:bg-[var(--brutal-yellow)]"
                            }`}
                        >
