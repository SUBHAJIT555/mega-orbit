...
const SingleItem = ({ item }) => {
  ...
  return (
    <div className="flex items-center border-t-2 border-[var(--brutal-black)] py-5 px-7.5 bg-white">
        ...
        <div className="flex items-center justify-between gap-5">
          <div className="w-full flex items-center gap-5.5">
            <div className="flex items-center justify-center rounded-none border-2 border-[var(--brutal-black)] bg-[var(--brutal-bg)] max-w-[80px] w-full h-17.5 overflow-hidden">
              <Image width={200} height={200} src={item.img || "/images/products/product-1-bg-1.png"} alt={item.title} className="object-cover w-full h-full" />
            </div>
      ...
      <div className="min-w-[275px]">
        <div className="w-max flex items-center rounded-none border-2 border-[var(--brutal-black)]">
          <button
            onClick={() => handleDecreaseQuantity()}
            aria-label="button for remove product"
            className="flex items-center justify-center w-11.5 h-11.5 ease-out duration-200 text-[var(--brutal-black)] hover:bg-[var(--brutal-yellow)] font-black"
          >
            <svg
          ...
          <span className="flex items-center justify-center w-16 h-11.5 border-x-2 border-[var(--brutal-black)] font-bold text-[var(--brutal-black)] bg-[var(--brutal-bg)]">
            {quantity}
          </span>
      ...
      <div className="min-w-[200px]">
        <p className="font-bold text-[var(--brutal-black)]">₹{(item.discountedPrice * quantity).toLocaleString('en-IN')}</p>
      </div>
