  ...
  return (
    <>
      ...
      {cartItems.length > 0 ? (
        <section className="overflow-x-hidden py-20 bg-[var(--brutal-bg)] border-t-4 border-[var(--brutal-black)]">
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            <div className="flex flex-wrap items-center justify-between gap-5 mb-7.5 p-4 rounded-none border-[3px] border-[var(--brutal-black)] bg-white brutal-box">
              <h2 className="font-black text-[var(--brutal-black)] text-2xl uppercase tracking-tight">Your Cart</h2>
              <button
                type="button"
            ...
            <div className="bg-white rounded-none border-[3px] border-[var(--brutal-black)] brutal-box">
              <div className="w-full overflow-x-auto">
                <div className="min-w-[1170px]">
                  {/* <!-- table header --> */}
                  <div className="flex items-center py-5.5 px-7.5 border-b-2 border-[var(--brutal-black)] bg-[var(--brutal-bg)]">
                    <div className="min-w-[400px]">
                      <p className="font-black text-[var(--brutal-black)]">Product</p>
                    </div>

                    <div className="min-w-[180px]">
                      <p className="font-black text-[var(--brutal-black)]">Price</p>
                    </div>

                    <div className="min-w-[275px]">
                      <p className="font-black text-[var(--brutal-black)]">Quantity</p>
                    </div>

                    <div className="min-w-[200px]">
                      <p className="font-black text-[var(--brutal-black)]">Subtotal</p>
                    </div>
        ...
        <>
          <div className="text-center mt-8 py-12 px-4">
            <div className="mx-auto pb-7.5 inline-block rounded-none border-[3px] border-[var(--brutal-black)] bg-[var(--brutal-bg)] p-4 brutal-box">
              <svg
                className="mx-auto"
                width="100"
                height="100"
              ...
              >
                <circle cx="50" cy="50" r="50" fill="var(--brutal-bg)" stroke="var(--brutal-black)" strokeWidth="2" />
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
            ...
            <p className="pb-6 font-black text-[var(--brutal-black)] text-xl">Your cart is empty!</p>

            <Link
              href="/shop"
              className="w-96 mx-auto flex justify-center font-black text-[var(--brutal-black)] bg-[var(--brutal-yellow)] border-2 border-[var(--brutal-black)] py-[13px] px-6 rounded-none brutal-btn hover:bg-[var(--brutal-cyan)]"
            >
              Continue Shopping
            </Link>
          </div>
